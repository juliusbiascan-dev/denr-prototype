...
export default function Home() {
  return (
    <PageContainer scrollable={true}>
      ...
      <div className="h-screen w-full bg-gradient-to-br from-green-50 to-blue-50 flex flex-col">
        {/* Navigation */}
        ...
        {/* Main Content */}
        <div className="flex-1 flex items-center justify-center mt-20 px-4 sm:px-6 lg:px-8">
        ...
        {/* Footer */}
        <footer className="bg-gray-800 text-white mt-20 py-4">
