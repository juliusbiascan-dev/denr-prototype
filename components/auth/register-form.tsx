      ...
      headerComponent={
        <div className="flex items-center justify-center space-x-2 flex-wrap">
          <Image
            ...
            width={40}
            height={40}
            className="rounded-full border-2 border-[#08933D] sm:w-12 sm:h-12"
          />
          <span className="text-xl sm:text-2xl font-bold text-[#08933D] dark:text-white">
            Create Account
          </span>
        </div>
      }
        ...
        >
          <div className="space-y-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-[#08933D] font-medium">Name</FormLabel>
                  <FormControl>
                    <Input
                      {...field}
                      disabled={isPending}
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      ...
                      placeholder="Email"
                      type="email"
                      className="border-2 border-[#7FA8A7]/30 dark:border-gray-700 focus:border-[#08933D] rounded-lg shadow-sm disabled:opacity-50"
                    />
                  </FormControl>
                  {inviteEmail && (
                    <p className="text-xs text-[#7FA8A7]">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-[#08933D] font-medium">Confirm Password</FormLabel>
                  <FormControl>
                    <PasswordInput
                      {...field}
                      disabled={isPending}
